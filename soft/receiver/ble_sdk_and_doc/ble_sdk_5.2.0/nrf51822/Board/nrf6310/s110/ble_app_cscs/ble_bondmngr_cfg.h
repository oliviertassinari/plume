...
/** @file
 *
 * @defgroup ble_sdk_app_cscs_bondmngr_cfg CSCS Bond Manager Configuration
 * @{
 * @ingroup ble_sdk_app_cscs
...
/**@brief Number of CCCDs used in the CSCS application. */
#define BLE_BONDMNGR_CCCD_COUNT            3
