...
/** @file
 *
 * @defgroup ble_sdk_app_alert_notification_bondmngr_cfg Alert Notification Bond Manager Configuration
 * @{
...
/**@brief Number of CCCDs used in the alert notification application. */
