...
CDCOBJS   = $(addprefix $(OBJDIR)/, $(notdir $(CDCSRC:.codec=.o)))
OBJS	  = $(CDCOBJS) $(ASMXOBJS) $(ASMOBJS) $(ACOBJS) $(TCOBJS) $(ACPPOBJS) $(TCPPOBJS)
...
$(CDCOBJS) : $(OBJDIR)/%.o : %.binary Makefile
ifeq ($(USE_VERBOSE_COMPILE),yes)
	@echo
