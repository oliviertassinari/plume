...
nobleBindings.onConnect = function(address, error) {
    ...
    if (typeof this._l2capBle[address] !== "undefined") {
            if (!error) {
        ...
        this.emit('connect', uuid, 'Error: Transport endpoint is not connected')
    }
...
nobleBindings.discoverServices = function(peripheralUuid, uuids) {
    if (this._l2capBle[this._addresses[peripheralUuid]] != null) {
        return this._l2capBle[this._addresses[peripheralUuid]].discoverServices(uuids || []);
    }
};
